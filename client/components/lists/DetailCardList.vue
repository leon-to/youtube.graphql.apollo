        ...
        <div class="flex flex-col w-full">
          ...
          <div class="flex flex-row gap-2 mt-2">
            ...
            <div clas="flex flex-col">
              ...
              <a class="mt-2 text-xs text-gray-400 hover:text-gray-100" href="#"> Leon To </a>
              <p class="mt-1 text-xs text-gray-400">{{video.views}}K views . 3 years ago</p>
            </div>
...
export default{
  ...
  methods:{
    updateVideos: async function () {
      ...
      `
      this.videos = (await request('http://localhost:4000', query)).videos
    }
  },
  mounted(){
    this.updateVideos()
    this.interval = setInterval(this.updateVideos, 1000)
  },
  beforeDestroy () {
